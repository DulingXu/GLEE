...
docker exec -it glee4 chmod +x /expr/glee-etcd
docker exec -it glee5 chmod +x /expr/glee-etcd
docker exec -it glee6 chmod +x /expr/glee-etcd
docker exec -it glee7 chmod +x /expr/glee-etcd
docker exec -it glee8 chmod +x /expr/glee-etcd
docker exec -it glee9 chmod +x /expr/glee-etcd
