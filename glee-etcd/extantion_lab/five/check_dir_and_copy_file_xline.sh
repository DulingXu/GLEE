...
docker exec -it glee1 chmod +x /expr/xline
docker exec -it glee2 chmod +x /expr/xline
docker exec -it glee3 chmod +x /expr/xline
docker exec -it glee4 chmod +x /expr/xline
docker exec -it glee5 chmod +x /expr/xline