...
# 在队列上创建分类，句柄编号 40:0，父类编号 1:4，延迟时间 time1
tc qdisc add dev eth0 parent 1:4 handle 40: netem delay $time1

# 在队列上创建分类，句柄编号 50:0，父类编号 1:5，延迟时间 time2
tc qdisc add dev eth0 parent 1:5 handle 50: netem delay $time2
...
# 在队列上创建分类，句柄编号 50:0，父类编号 1:5，延迟时间 time3
tc qdisc add dev eth0 parent 1:5 handle 50: netem delay $time3
